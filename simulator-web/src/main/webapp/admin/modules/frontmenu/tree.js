...
var setting = {
	    ...
	    async: {
	        enable: true,
	        url: Config.apiPath+"commMods/ajax?action=frontMenuAction&verb=getMenusBypid&token=" + token,
...
function onDr(event,treeId,treeNode,targetNode, moveType){
	var nodeIds = [];
	if (moveType == "inner"){
		JqdeMods.ajax('frontMenuAction', 'updateMenus', 
		...
		JqdeMods.ajax('frontMenuAction', 'updateCseq', 
